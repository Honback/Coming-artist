...
export function MusicNoteIcon({ className, size = 24, color = "currentColor" }: IconProps) {
  return (
    <svg
...
export function FilmIcon({ className, size = 24, color = "currentColor" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function GuitarIcon({ className, size = 24, color = "currentColor" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      className={className}
    >
      <path d="m22 2-5 5-5-5-3 1 7 7 1-3 5 5-5 5-1-3-7 7 3 1 5-5 5 5 1-3-7-7 3-1 5-5-5-5Z" />
    </svg>
  );
}

export function KeyboardIcon({ className, size = 24, color = "currentColor" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
