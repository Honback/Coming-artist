  ...
  return (
    ...
    >
      ...
      <Tabs defaultValue="prevention" className="max-w-4xl mx-auto">
        <TabsList className="grid w-full grid-cols-2 mb-8 bg-purple-600/20">
          <TabsTrigger
            value="prevention"
        ...
        <TabsContent value="prevention" className="mt-4">
          <PosterCard title="1. 성희롱·성폭력 예방 교육" color="purple">
            <div className="mb-8">
              <h4 className="text-xl font-semibold mb-4">교육 내용:</h4>
              <ul className="space-y-3 ml-6">
                <li className="flex items-center gap-2">
                  <div className="size-2 rounded-full bg-purple-500 shrink-0 mt-1.5" />
            ...
            <blockquote className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500 mb-4 text-zinc-700">
        ...
        <TabsContent value="contract" className="mt-4">
          <PosterCard title="2. 계약 교육" color="blue">
            <div className="mb-8">
              <h4 className="text-xl font-semibold mb-4">교육 내용:</h4>
              <ul className="space-y-3 ml-6">
                <li className="flex items-center gap-2">
            ...
            <blockquote className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-600 mb-4 text-zinc-700">
